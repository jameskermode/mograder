...
Layer 1: spawn_headless_edit() — shared by student_app and grader
Layer 2: EditSessionManager — grader session lifecycle
...
# ---------------------------------------------------------------------------
# Layer 2: Session manager (grader-specific)
# ---------------------------------------------------------------------------
...
class EditSessionManager:
    """Manage headless marimo edit sessions for the grader.
...
class MarimoOptimizeMiddleware:
    ...
    Used by both the edit proxy and the grader marimo app.
    """
