...
def _(mo):
    ...
    _mograder_checks = [
        ("Q1: Palindrome checker", "FAIL"),
        ("Q2: Word counter", "PASS"),
    ]
    _cell_errors = 0
    _table = "\n".join(
...
def _(mo):
    ...
    _mark = 45  # e.g. _mark = 65
    _feedback = "Palindrome misses spaces. Word counter is good."  # e.g. _feedback = "Good analysis of the DP approach..."
    ...
    if _mark is not None:
        ...
        mo.callout(
            mo.md("**Awaiting GTA feedback** — edit `_mark` and `_feedback` above"),
            kind="warn",
        )
    return
