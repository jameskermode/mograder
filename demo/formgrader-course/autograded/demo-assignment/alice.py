...
def _(mo):
    ...
    _mark = 50  # e.g. _mark = 60
    _feedback = "Strong analysis covering accuracy and limitations."  # e.g. _feedback = "Good analysis of the DP approach..."

    # --- display (do not edit below) ---
    if _mark is not None:
        _total = 40 + _mark
        mo.callout(
            mo.md(f"**Mark: {_total}/100** (auto: 40, manual: {_mark})\n\n{_feedback}"),
            kind="success",
        )
    else:
        mo.callout(
