...
def _(mo):
    ...
    _mark = 55  # e.g. _mark = 75
    _feedback = "Thorough analysis with good examples."  # e.g. _feedback = "Good analysis of the DP approach..."
    ...
    if _mark is not None:
        ...
        mo.callout(
            mo.md(
                "**Awaiting GTA feedback** — edit `_mark` (out of 75) and `_feedback` above\n\n"
                f"Auto marks so far: 25/25"
            ),
            kind="warn",
        )
    return
