"""Tests for grader directory scanning and UI helpers."""

from mograder.grading.cells import inject_grading_cells
from mograder.grader.scanner import (
...
# --- grader app source code assertions ---
...
def test_collect_student_marks_empty(tmp_path):
    ...
    from mograder.grader.scanner import AssignmentInfo
...
def test_app_has_grading_tab():
    """The grader app should have a Grading tab."""
    from pathlib import Path
...
def test_collect_student_marks_custom_dirs(tmp_path):
    ...
    from mograder.grader.scanner import AssignmentInfo, DirNames
...
def _read_app_source() -> str:
    """Read the grader app.py source code."""
    from pathlib import Path
